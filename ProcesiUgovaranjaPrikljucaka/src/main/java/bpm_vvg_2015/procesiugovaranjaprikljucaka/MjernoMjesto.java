...
public class MjernoMjesto implements java.io.Serializable
{
   ...
   @org.kie.api.definition.type.Label(value = "Broj_mjernog_mjesta")
   private java.lang.String brojMjernogMjesta;
   @org.kie.api.definition.type.Label(value = "Datum_aktiviranja")
   private java.util.Date datumAktiviranja;
   @org.kie.api.definition.type.Label(value = "Broj_vodomjera")
